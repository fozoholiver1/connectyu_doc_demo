...
<section class="text-gray-600 body-font bg-green-300">
    <div class="container px-5 py-10 mx-auto">
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-5">Create A New ConnectYu Video Tutorial
            {{--            <br class="sm:block">Selfies Wayfarers--}}
        </h1>
        {{--        <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">--}}
        <livewire:forms.create-video/>
        {{--        </div>--}}
    </div>
</section>
...
<section class="text-gray-700 body-font bg-green-200">
    <div class="container px-8 py-2 mx-auto lg:px-4">
        <div class="flex flex-col w-full mb-2 text-left lg:text-center">
            ...
            <form method="post" action="/documentations" enctype="multipart/form-data">
@csrf
                ...
                <div class="w-full p-2" >
                    <input type="text"
                           id="password" name="topic" placeholder="topic of your tutorial"
                           class="w-full px-4 py-2 mr-4 text-base text-blue-700 bg-gray-100 border-transparent rounded-lg focus:border-gray-
                       500 focus:bg-white focus:ring-0">
                </div>
                ...
                <div>
                    ...
                    <div class="mb-4" >
                        ...
                        @trix(\App\Models\Documentation::class, 'article', )
                    </div>
                    </div>
